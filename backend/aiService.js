...
async function generateResponse(question, preferredSubject = null) {
...
function getDetailedResponse(category, question, questionType) {
  ...
  if (questionType === 'definition') {
    // Return a definition-style response based on category
    const definitions = {
      math: "In mathematics, ... (generic definition)",
      science: "In science, ...",
      history: "In history, ..."
    };
    return definitions[category] || "Let me define that term for you.";
  }
  ...
  if (questionType === 'example') {
    const examples = {
      ...
      science: "For example: ...",
      history: "An example would be: ..."
    };
    return examples[category] || "Here is an example: ...";
  }
