...
node simulate-activity.js --scenario high-load --concurrency 8 --duration 300 --peak-interval 20 --profile balanced
node simulate-activity.js --scenario error-spikes --concurrency 5 --duration 240 --error-rate 0.35 --profile mixed
node simulate-activity.js --scenario resource-constraint --concurrency 6 --duration 240 --profile mobile
```
...
| `--profile`       | `balanced`    | `balanced`, `mobile`, `mixed`                                 |
| `--reconnect-rate`| `0.05`        | Probability of injecting reconnect-style headers             |
