...
const SUBJECT_OPTIONS = ['Mathematics', 'Science', 'English', 'History', 'Filipino', 'Computer Science', 'Other'];
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.headerActions}>
          ...
          <Link href="/"><a style={styles.navLink}>Chat</a></Link>
      ...
      <form onSubmit={handleUpdate} style={styles.form}>
        <div style={styles.formCard}>
          ...
          <textarea value={bio} onChange={e => setBio(e.target.value)}
            style={styles.textarea} maxLength={500}
...
const styles = {
  container: { maxWidth: '600px', margin: '0 auto', padding: '20px', fontFamily: 'Nunito, sans-serif' },
  header: {
  ...
  logoutBtn: {
    backgroundColor: 'transparent', color: '#c62828', border: '1px solid #ffcdd2',
  ...
  label: { display: 'block', fontWeight: 600, color: '#333', margin: '16px 0 6px 0', fontSize: '14px' },
  input: {
    display: 'block', width: '100%', padding: '12px 14px', borderRadius: '8px',
    border: '2px solid #e0e0e0', fontSize: '15px', outline: 'none', boxSizing: 'border-box',
  },
  textarea: {
    display: 'block', width: '100%', padding: '12px 14px', borderRadius: '8px',
    border: '2px solid #e0e0e0', fontSize: '15px', outline: 'none', resize: 'vertical',
  ...
  successBanner: {
    backgroundColor: '#e8f5e9', color: '#2e7d32', padding: '12px',
